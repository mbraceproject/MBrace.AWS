...
type private AWSArguments =
    ...
    interface IArgParserTemplate with
        member arg.Usage =
            ...
            | Runtime_Bucket _ -> "Specifies the blob container name used for persisting MBrace cluster data."
            | User_Data_Bucket _ -> "Specifies the blob container name used for persisting MBrace user data."
